...
\begin{abstract}
  UPDATED---\today. Gardener's Best Friend is a mobile app for people who want to journal the status of their plants. The journal houses information about the plants' health and watering schedules entered by the user, as well as sunlight preferences. The purpose of this app is for users to keep up with their plants' schedules and learn more about their garden, and for users to get closer to their plants by taking pictures and writing about them in a journal. Gardener's Best Friend allows the user to add a plant, asking them to enter information about the plant, whether the plant is inside or outside, and a picture of the plant that is either taken from the camera or added from the gallery. Once a plant is added, the user can then provide updates to their plant, take or upload new pictures of their plant, and write about their plant in a journal. The app also provides general information about each of the user's plants, such as the plant's preferences. The app can also send notifications to the user reminding them when they need to water their plants, using a watering schedule provided by the user, and also uses the user's location and weather to determine if the user needs to water their plant that day.
\end{abstract}
