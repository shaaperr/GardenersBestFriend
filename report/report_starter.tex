...
\section{Technology}
Gardener's Best Friend is created in Android Studio using Kotlin. It uses an API developed by Perenual to access information from a plant database developed by the same company, which contains information such as how much sunlight a plant prefers or how much water a plant needs. We also use Canva to develop mockups and backgrounds for the app. Lastly, we use GitHub as version control for the project.
